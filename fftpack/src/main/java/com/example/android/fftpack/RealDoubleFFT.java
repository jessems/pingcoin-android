package com.example.android.fftpack;
...
public class RealDoubleFFT extends RealDoubleFFT_Mixed
{
    ...
    {
        if(x.length != ndim)
            throw new IllegalArgumentException("The length of data can not match that of the wavetable " + ndim + " " + x.length);
            Log.e("RealDoubleFFT", "ndim: " + ndim + " and x.length: " + x.length);
