...
import com.example.android.pingcoin2.AudioEvent;
import com.example.android.pingcoin2.AudioProcessor;
...
public class PitchProcessor implements AudioProcessor {
    ...
    public enum PitchEstimationAlgorithm {
        ...
        FFT_PITCH,
        /**
         * Ping onset detection
         */
        PING_ONSET_DETECTION,
        /**
        ...
        public PitchDetector getDetector(float sampleRate,int bufferSize){
            ...
            } else if (this == PING_ONSET_DETECTION){
                detector = new PingOnsetDetection(Math.round(sampleRate),bufferSize);
            } else {
