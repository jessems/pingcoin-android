 ...
 */
public final class PingOnsetDetection implements PitchDetector {
    /**
     ...
     */
    public PingOnsetDetection(final float audioSampleRate, final int bufferSize) {
     ...
     */
    public PingOnsetDetection(final float audioSampleRate, final int bufferSize, final double yinThreshold) {
    ...
    public PitchDetectionResult getPitch(final float[] audioBuffer) {
        ...
        Log.i("PingOnsetDetection", "Setting audioBuffer: " + Arrays.toString(audioBuffer));
        result.setAudioBuffer(audioBuffer);
