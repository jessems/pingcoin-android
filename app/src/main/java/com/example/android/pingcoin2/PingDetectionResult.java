 ...
 * @author Joren Six
 */
public class PingDetectionResult {
    /**
     * The pitch in Hertz.
     */
    private float pitch;
     ...
     * @param other
     */
    public PingDetectionResult(PingDetectionResult other){
     ...
     */
    public PingDetectionResult clone(){
        return new PingDetectionResult(this);
    }
